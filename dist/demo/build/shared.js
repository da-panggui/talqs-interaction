...
(function (global, factory) {
  ...
  var TALQS_EVENT = {
    ...
    CHANGE: EVENT_NAME_SAPCE + "_CHANGE" };

  // 用户作答数据更新
  var dispatchUpdateEvent = function dispatchUpdateEvent(data) {
    ...
    BlankType.prototype.updateBlankValueByIndex = function updateBlankValueByIndex(index, value) {
      ...
      if (!isNaN(index)) {
        ...
        if (currentValue !== value) {
          ...
          // 检测是否有有效数据
          var validate = this._blankData.some(function (item) {
            return item;
          });
  ...
  var DropdownTypeQuestion = function ($) {
    ...
    DropdownType.prototype.updateBlankValueByIndex = function updateBlankValueByIndex(index, value) {
      ...
      if (!isNaN(index)) {
        ...
        // 检测是否有有效数据
        var validate = this._selectData.some(function (item) {
          return item;
        });
  ...
  // 模板辅助函数
  // 注册交互版本的组件和辅助函数
  var registerInteractiveTemplate = function registerInteractiveTemplate(TalqsTemplate) {
    // 注册交互版组件
  ...
  var switchInteractive = function switchInteractive(interactive) {
    if (interactive) {
